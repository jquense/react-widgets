...
var Select = React.createClass({
  ...
  getInitialState: function(){
    ...
    return {
      ...
      dataItems: _.map(values, function(item)  {return this._dataItem(this.props.data, item);}.bind(this))
    }
  },
  ...
  componentWillReceiveProps: function(nextProps) {
    ...
    this.setState({
      processedData: items,
      dataItems: _.map(values, function(item)  {return this._dataItem(nextProps.data, item);}.bind(this))
    })
  },
