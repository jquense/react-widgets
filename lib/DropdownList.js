...
var _reactWindowMixins = require('react-window-mixins');
...
var DropdownList = _react2['default'].createClass(babelHelpers.createDecoratedObject([{
  ...
  key: 'mixins',
  initializer: function initializer() {
    return [_reactWindowMixins.OnResize, require('./mixins/TimeoutMixin'), require('./mixins/PureRenderMixin'), require('./mixins/DataFilterMixin'), require('./mixins/PopupScrollToMixin'), require('./mixins/RtlParentContextMixin'), require('./mixins/AriaDescendantMixin')()];
  }
}, {
  key: 'propTypes',
  initializer: function initializer() {
