...
This is called a **controlled** component because the parent is in complete _control_ of setting the `value` prop,
...
<PropExample
  codeText={require('../props-examples/open').default('DropdownList')}
/>
