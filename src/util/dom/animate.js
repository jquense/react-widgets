...
if ( canUseDOM ) {
  ...
  reset[transitionProperty = transition.prefix + 'transition-property'] =
  reset[transitionDuration = transition.prefix + 'transition-duration'] =
  reset[transitionDelay    = transition.prefix + 'transition-delay'] =
  reset[transitionTiming   = transition.prefix + 'transition-timing-function'] = ''
}
