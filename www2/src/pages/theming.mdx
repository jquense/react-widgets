...
Follow the conventions for overriding default variable values for Sass, depending on what you use. All
are stored in a `variables` file, see `./lib/{less,scss}/variables.scss` for reference. There are a ton
of knobs to tweak!
