...
//   .add('DropdownList', () => (
//     <Container>
//       <DropdownList {...props} defaultOpen />
//     </Container>
//   ))
//   .add('DropdownList open', () => (
//     <Container>
//       <DropdownList {...props} open />
//     </Container>
//   ))
//   .add('DropdownList groupBy', () => (
//     <Container>
//       <DropdownList {...props} defaultOpen groupBy="last" />
//     </Container>
//   ))
//   .add('Uniform type', () => (
//     <Container>
//       <DropdownList {...props} type="uniform" />
//     </Container>
//   ))
//   .add('Static item height', () => (
//     <Container>
//       <DropdownList {...props} defaultOpen itemSizeGetter={() => 25} />
//     </Container>
//   ))
