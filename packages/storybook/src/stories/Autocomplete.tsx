...
storiesOf('Autocomplete', module)
  ...
  .add('busy', () => (
    <Container>
      <Autocomplete {...props} busy defaultValue={props.data[1]} />
    </Container>
  ))
  .add('disabled', () => (
    <Container>
      <Autocomplete {...props} disabled defaultValue={props.data[1]} />
    </Container>
  ))
  .add('disabled items', () => (
    <Container>
  ...
  .add('disabled item, first focused', () => (
    <Container>
      <Autocomplete {...props} open disabled={props.data.slice(0, 2)} />
    </Container>
  ))
  .add('readOnly', () => (
    <Container>
      <Autocomplete {...props} readOnly defaultValue={props.data[1]} />
    </Container>
  ))
